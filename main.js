...
var AddressBook = /** @class */ (function () {
    ...
    AddressBook.prototype.findContactByName = function (name) {
        var _a;
        return (_a = this.contacts) === null || _a === void 0 ? void 0 : _a.find(function (contact) { return contact.name === name; });
    };
    ...
    AddressBook.prototype.searchContacts = function (searchTerm) {
        ...
        return (_a = this.contacts) === null || _a === void 0 ? void 0 : _a.filter(function (contact) { var _a; return (_a = contact.name) === null || _a === void 0 ? void 0 : _a.toLowerCase().includes(normalizedSearchTerm); });
    };
